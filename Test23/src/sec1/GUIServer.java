...
class ManagerLogin extends JFrame implements ActionListener, KeyListener {	//GUI 관리자 창 
	...
	public ManagerLogin() {
		...
		port_log.setBackground(Color.GRAY);
		setTitle("GUI 관리자 창");
...
class ChatServerGUI extends JFrame implements ActionListener, KeyListener {
	...
	public void FontTest() {
		...
		f_BOLD = new Font("맑은 고딕", Font.BOLD, 20);
		serverLabel.setFont(f_BOLD);
		userLable.setFont(f_BOLD);
		}
	...
	public void Image() {
		...
		lb1.setIcon(icon);
		serverGUI_Panel.add(lb1);
	}
	
	public ChatServerGUI(int port) {
		serverGUI_Panel.setBackground(Color.gray);
		setTitle("메인 서버");
		setVisible(true);
		setLocationRelativeTo(null);
		setSize(750, 620);
